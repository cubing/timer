import { rn, get8Perm, set8Perm, Solver, coord, acycle, fillFacelet } from "../lib/mathlib";

var solv = new Solver(3, 3, [[0, [doPermMove, 'p', 7], 5040], [0, [doOriMove, 'o', 7, -3], 729]]);
...
function getScramble(type?: any, length?: any, state?: any) {
	var ori, perm, lim;
	...
	do {
		...
		if (type == '222o' || type == '222so') {
			...
			var arr = set8Perm([0, 0, 0, 0].concat(egperms[perm]), rn(24), 4);
			perm = get8Perm(arr, 7);
			var rndU = rn(4);
