...
Search.prototype.next = function (probeMax, probeMin, verbose) {
	...
	this.isRec = true;
	this.verbose = verbose;
	throw new Error("TODO: Figure out what search to use.")
	// return search();
}
...
function initBasic() {
	{ //init sym cubes
		...
		function initSymMoveTable(moveTable, SymS2R, N_SIZE, N_MOVES, setFunc, getFunc, multFunc, ud2std?: any) {
