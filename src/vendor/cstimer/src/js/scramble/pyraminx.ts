import { rn, get8Perm, set8Perm, fillFacelet, Solver, acycle, coord } from "../lib/mathlib";
...
var eocoord = new coord('o', 6, -2);
var epcoord = new coord('p', 6, -1);
var cocoord = new coord('o', 4, 3);
