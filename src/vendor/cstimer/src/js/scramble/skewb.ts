import { rn, fillFacelet, coord, acycle, Solver } from "../lib/mathlib";
...
var ctcord = new coord('p', 6, -1);
var cpcord = new coord('p', 4, -1);
var ftcord = new coord('o', 4, 3);
var twcord = new coord('o', 4, -3);
...
var solv = new Solver(4, 2, [
	[0, ctcpMove, 4320],
	[0, twstMove, 2187]
]);

var solvivy = new Solver(4, 2, [
	[0, function(idx, m) {
