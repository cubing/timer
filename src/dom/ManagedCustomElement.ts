...
// Customized built-in elements are not supported in Safari, so we stick with repl
export function replaceDOMElement(
  oldElement: HTMLElement,
  replacementElement: HTMLElement
): void {
  oldElement.insertAdjacentElement("beforebegin", replacementElement);
